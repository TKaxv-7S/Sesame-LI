...
public class AntFarm extends ModelTask {
        ...
        try {
            ...
            if (AnimalInteractStatus.HOME.name().equals(ownerAnimal.animalInteractStatus)) {
                ...
                if (AnimalBuff.ACCELERATING.name().equals(ownerAnimal.animalBuff)) {
                    ...
                    //     needReload = true;
                    // }
                    if (useAccelerateToolBeforeCheck(ownerFarmId)) {
                        needReload = true;
                    }
                }
    ...
    private boolean useAccelerateToolBeforeCheck(String userId) {
        if (!Status.canUseAccelerateTool()) {
            return false;
        }
        syncAnimalStatus(userId);
        double eatten = 0d;
        ...
        // 180 - eatten >= 36
        while (eatten <= 144 && useFarmTool(userId, ToolType.ACCELERATETOOL)) {
