...
public class AntForestV2 extends ModelTask {
    ...
    private void consumeAnimalProp(JSONObject animalProp) {
        ...
        try {
            String propGroup = animalProp.getJSONObject("main").getJSONObject("propGroup");
            String propType = animalProp.getJSONObject("main").getJSONObject("propType");
            String name = animalProp.getJSONObject("partner").getJSONObject("name");
